...
export default function Roe1() {
  ...
  return (
    <>
      <ul className="roe-links" aria-label="עמודים">
        ...
        <li className={pathname === "/roe2" ? "active" : ""}>
          <Link
            href="/roe2"
        ...
        <li className={pathname === "/roe3" ? "active" : ""}>
          <Link
            href="/roe3"
        ...
        <li className={pathname === "/roe4" ? "active" : ""}>
          <Link
            href="/roe4"
        ...
        <li className={pathname === "/roe5" ? "active" : ""}>
          <Link
            href="/roe5"
        ...
        <li className={pathname === "/roe6" ? "active" : ""}>
          <Link
            href="/roe6"
        ...
        <li className={pathname === "/roe7" ? "active" : ""}>
          <Link
            href="/roe7"
        ...
        <li className={pathname === "/roe8" ? "active" : ""}>
          <Link
            href="/roe8"
