    ...
    <>
      <div className="about-container">
        ...
        <p>
          ...
          כלשונו ללא שינוי.נוסף פרק הרואה ממסכת ברכות לפתרון חלומות . אלו
          המקורות האמינים והטובים ביותר לפתרון חלומות , יש רק לדעת שניתן לתקן
          חלום רע על ידי כמה אופנים מקובלים .
        </p>
