  ...
  return (
    <>
      <div className="about-container">
        ...
        <p>
          מהדורת אינטרנט לספר סדר פתרון חלומות מרב האי גאון זצ"ל נעתק כלשונו ללא
          שינוי.נוסף פרק הרואה ממסכת ברכות לפתרון חלומות . אלו מקורות האמינים
          והטובים ביותר לפתרון חלומות . ויש לקחת ברצינות את כל הנאמר רק לדעת
          שניתן לתקן חלום רע על ידי כמה אופנים מקובלים שבראשם תשובה וצדקה .
        </p>
